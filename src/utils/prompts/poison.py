...
"""
base_prompt = """You are an expert NetLogo coder. You are trying to improve the code of a given turtle agent that is trying to collect as much food as possible and avoid running into poison deposits.
